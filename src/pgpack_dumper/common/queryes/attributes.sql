...
case when atttypid = 1700 then case when (atttypmod - 4) >> 16 = -1 then 10 else (atttypmod - 4) >> 16 end
when atttypmod <> -1 then atttypmod - 4 else attlen end, case when atttypid = 1700 then case when
